...
async function seedFabricShops() {
  ...
  const shops = await FabricShop.insertMany([
    ...
    },
    {
      ...
      pickupAddress: {
        fullName: "Mauzan Textiles",
        phone: "+97123456789",
        line1: "Khalifa Street",
        line2: "",
        city: "Abu Dhabi",
        emirate: "Abu Dhabi",
      },
    ...
    },
    {
      ...
      pickupAddress: {
        fullName: "Sharjah Heritage Fabrics",
        phone: "+97164567890",
  ...
  const shops = await TailorShop.insertMany([
    {
      ...
      pickupAddress: {
        fullName: "Ayesha Al Riaz Atelier",
        phone: "+97143532100",
        line1: "Al Fahidi Historical District",
        line2: "",
        city: "Dubai",
        emirate: "Dubai",
      },
    ...
    },
    {
      ...
      pickupAddress: {
        fullName: "Asma Al Naeem Couture",
        phone: "+97126784500",
        line1: "Corniche Road",
        line2: "",
        city: "Abu Dhabi",
