  ...
  const fabrics = await Fabric.insertMany([
    {
      ...
      images: ['/images/dress-1.png', '/images/dress-2.png', '/images/dress-3.png'],
    ...
    },
    {
      ...
      images: ['/images/dress-2.png', '/images/dress-3.png', '/images/dress-4.png'],
      material: 'chiffon',
      materialAr: 'شيفون',
      colors: ['camel', 'brown'],
      city: 'Abu Dhabi',
    ...
    },
    {
      ...
      images: ['/images/dress-3.png', '/images/dress-4.png', '/images/dress-5.png'],
    ...
    },
    {
      ...
      images: ['/images/dress-4.png', '/images/dress-5.png', '/images/dress-1.png'],
      material: 'silk velvet',
      materialAr: 'مخمل حرير',
      colors: ['grey', 'black'],
      city: 'Ras Al Khaimah',
    ...
    },
    {
      ...
      images: ['/images/dress-5.png', '/images/dress-1.png', '/images/dress-2.png'],
      material: 'silk velvet',
      materialAr: 'مخمل حرير',
      colors: ['ivory', 'white'],
      city: 'Ajman',
