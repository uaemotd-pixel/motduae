...
import { registerPartnerPayoutAdminRoutes } from "./partnerPayoutAdminRoutes.js";
import {
  ...
  expressAsyncHandler(async (req, res) => {
    ...
    if (order) {
      ...
      if (status) {
        ...
        await maybeMarkEarningsAvailable(updatedOrder, "retail");
      }
  ...
  expressAsyncHandler(async (req, res) => {
    ...
    if (order) {
      ...
      if (status) {
        ...
        await maybeMarkEarningsAvailable(updatedOrder, "custom");
      }
...
registerPartnerPayoutAdminRoutes(adminRouter);
