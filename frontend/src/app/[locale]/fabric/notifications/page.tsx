...
function NotificationOrderSummary({
  ...
  const t = useTranslations("FabricPortal.Notifications");
...
export default function FabricNotificationPage() {
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {sortedItems.map((n) => {
            ...
            const actionHref = getFabricActionHref(n);
