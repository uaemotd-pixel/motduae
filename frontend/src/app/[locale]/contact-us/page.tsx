                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6">
                        ...
                        <div className="text-center mb-16">
                            ...
                            <h1 className="[font-family:var(--font-display)] text-4xl sm:text-5xl font-light tracking-tight text-black mb-4">
                                {isAr ? "يسعدنا دائمًا سماع رأيك" : "We'd Love to Hear From You"}
                            </h1>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                            ...
                            <div className="lg:col-span-7 bg-white border border-[#E8E8E4] rounded-2xl p-8 shadow-sm">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-5 [font-family:var(--font-body)]">
                                    {/* Name Input */}
                                    <div className="space-y-2">
                                        <label htmlFor="name" className="text-xs uppercase tracking-wider font-semibold text-[#5A5A56] block">
                                    ...
                                    {/* Email Input */}
                                    <div className="space-y-2">
                                        <label htmlFor="email" className="text-xs uppercase tracking-wider font-semibold text-[#5A5A56] block">
                                    ...
                                    {/* Subject Input */}
                                    <div className="space-y-2">
                                        <label htmlFor="subject" className="text-xs uppercase tracking-wider font-semibold text-[#5A5A56] block">
                                            {isAr ? "موضوع الرسالة" : "Subject"} <span className="text-red-500">*</span>
                                        </label>
                                        <input
                                            type="text"
                                            id="subject"
                                            ...
                                            placeholder={isAr ? "عن ماذا تريد الاستفسار؟" : "What is this inquiry about?"}
                                            className="w-full h-11 px-4 bg-[#FFFDF9] border border-[#E8E8E4] rounded-xl focus:outline-none focus:border-black text-sm text-black transition-colors disabled:opacity-50"
                                            required
                                        />
                                    </div>
                                    ...
                                    {/* Message Input */}
                                    <div className="space-y-2">
                                        <label htmlFor="message" className="text-xs uppercase tracking-wider font-semibold text-[#5A5A56] block">
                                            {isAr ? "الرسالة" : "Your Message"} <span className="text-red-500">*</span>
                                        </label>
                                        <textarea
                                            id="message"
                                            disabled={loading}
                                            ...
                                            placeholder={isAr ? "اكتب تفاصيل رسالتك هنا..." : "Type your message here..."}
