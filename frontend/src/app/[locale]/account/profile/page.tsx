...
export default function ProfileTab({ onEditClick }: ProfileTabProps) {
  ...
  const DisplayField = ({
    ...
    <div className="space-y-1">
      <label className="font-ui text-[10px] sm:text-xs font-medium text-gray-500 uppercase tracking-wider">
        {label}
      </label>
      ...
      <div className="bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden">
        <div className="p-4 sm:p-6 md:p-8">
                        ...
                        {isExpanded && (
                          ...
                          >
                            <div className="p-4 pt-0 border-t border-gray-100">
                              <div className="grid grid-cols-2 gap-x-3 gap-y-3 sm:gap-4 pt-4">
                                <DisplayField
                                  label="Full Name"
          ...
          <div className="mt-6 sm:mt-8">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-3 gap-y-3 sm:gap-4">
