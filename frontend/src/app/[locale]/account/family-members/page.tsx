    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-row gap-2 sm:gap-3 items-center justify-between">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-black text-white rounded-lg text-sm hover:bg-black/80 transition hover:cursor-pointer shrink-0"
        >
      ...
      {filteredMembers.length === 0 ? (
        <div className="rounded-xl border border-gray-100 p-8 sm:p-12 text-center">
