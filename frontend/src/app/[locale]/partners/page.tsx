      ...
      <FadeInSection>
        <div className="bg-[#FAF9F6] text-black min-h-screen py-16 sm:py-24 antialiased selection:bg-black/10">
          <div className="max-w-6xl mx-auto px-6">
            ...
            {/* Statistics Banner */}
            <div className="grid grid-cols-1 sm:grid-cols-2 max-w-2xl mx-auto gap-6 sm:gap-0 bg-white border border-[#EAE6DF] rounded-2xl p-6 sm:p-8 mb-16 text-center sm:divide-x divide-[#EAE6DF] rtl:divide-x-reverse">
