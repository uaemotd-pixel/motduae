...
export default function AdminSettingsMaterialsPage() {
  ...
  const handleCreate = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      toast.error(getApiErrorMessage(err, "Failed to create material"));
    } finally {
      setCreating(false);
    }
  };
  ...
  const handleEditSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await api.put(`/api/admin/materials/${editingMaterial._id}`, {
    ...
    <div className="space-y-8">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0 pt-1">
              ...
              <p className="text-gray-500 text-sm">
                Manage fabric and garment materials across your platform
              </p>
            </div>
          </div>
        </div>
      ...
      {!loading && totalItems > 0 && (
        <div className="text-xs text-gray-400 font-medium tracking-wide uppercase">
          {searchQuery.trim()
            ? `${totalItems} matching material${totalItems === 1 ? "" : "s"}`
            : `${totalItems} material${totalItems === 1 ? "" : "s"} total`}
        </div>
      )}
        ...
        <div className="flex flex-col items-center justify-center text-center py-16">
          ...
          <p className="text-sm text-gray-500 max-w-sm">
            {searchQuery
              ...
              : "Use the form above to add your first material."}
          </p>
        </div>
      ) : (
                ...
                <form onSubmit={handleEditSubmit} className="space-y-5">
                  ...
                  <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-100">
                    ...
                    >
                      ...
                      {submittingEdit ? "Saving..." : "Update Material"}
                    </motion.button>
                  </div>
                </form>
              </div>
