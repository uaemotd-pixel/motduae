      ...
      try {
        ...
        if (data) {
          ...
          setFormData({
            ...
            tagAr: (data.tagAr as string) || "",
            colors: Array.isArray(data.colors) ? (data.colors as string[]) : [],
            images: gallery,
            isActive:
              data.isActive !== undefined ? Boolean(data.isActive) : true,
            fabricShopId:
              typeof data.fabricShopId === "string"
                ? data.fabricShopId
                : data.fabricShopId &&
                    typeof data.fabricShopId === "object" &&
                    "_id" in (data.fabricShopId as object)
                  ? String((data.fabricShopId as { _id: string })._id)
                  : "",
      ...
      >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          ...
          <div className="md:col-span-2 grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
            ...
            <FormField label="Colors" name="colors" error={fieldErrors.colors}>
              <AnimatedDropdown
                isOpen={openColors}
