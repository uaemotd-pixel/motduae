...
const REQUIRED_FIELDS: FormField[] = ["fullName", "phone", "line1", "city", "emirate"];
...
export default function CustomOrderCheckoutStep() {
    ...
    useEffect(() => {
        ...
        updateDeliveryAddress({
            fullName: draft.deliveryAddress.fullName || user?.name || "",
            phone: draft.deliveryAddress.phone || "",
            line1: draft.deliveryAddress.line1 || "",
            line2: draft.deliveryAddress.line2 || "",
            city: draft.deliveryAddress.city || "",
            emirate: draft.deliveryAddress.emirate || "",
        });
