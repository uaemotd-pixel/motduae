...
export function TrendingSection() {
    ...
    useEffect(() => {
        const fetchDesigns = async () => {
            try {
                setLoading(true);
                setError(null);
                const data = await api.get<{ success: boolean; items: TailorDesignExtended[] }>(
    ...
    return (
        <section id="stories" className="bg-(--bg-page) py-12 xs:py-16 sm:py-20 md:py-24 lg:py-(--space-80) border-(--color-border) mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-(--space-80)">
                        ...
                        <div className="flex -mx-1 xs:-mx-1.5 sm:-mx-2 md:-mx-2.5 lg:-mx-3">
                            {filteredDesigns.map((design) => {
                                ...
                                const tailorName = isArabic
                                    ...
                                    : design.tailorName;
                                const priceText = formatDesignBasePrice(design.basePrice, localParams as any);
