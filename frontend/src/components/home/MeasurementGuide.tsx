...
export function MeasurementGuide() {
  ...
  return (
    <section
      id="how-it-works"
      className="bg-black/95 text-white py-12 xs:py-16 sm:py-20 md:py-24 lg:py-(--space-80) relative overflow-hidden mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-(--space-80)"
    >
          ...
          <div>
            ...
            <div className="space-y-4 xs:space-y-5 sm:space-y-6">
              {tips.map((tip) => (
                <div
                  key={tip.number}
                  className="flex gap-3 xs:gap-4 items-start group"
                >
