...
export function PartnerSection({ 
    ...
    return (
        <section id="about" className="py-12 xs:py-16 sm:py-20 md:py-24 lg:py-section-gap px-4 xs:px-6 sm:px-8 md:px-12 lg:px-margin-desktop max-w-container-max mx-auto mb-12 xs:mb-16 sm:mb-20 md:mb-24 lg:mb-(--space-80)">
