...
const CollapsibleFilter = ({
  ...
  return (
    <div className="border-b border-[#E4E0D8] pb-3 sm:pb-4">
      ...
      {isOpen && <div className="mt-2.5 sm:mt-3 flex flex-col gap-2">{children}</div>}
    </div>
  );
};
    ...
    <div className="min-h-screen bg-white" data-catalog-shop>
      <FadeInSection>
        ...
        <div className="py-12 sm:py-16 lg:py-24 border-b border-[#E4E0D8] px-4 sm:px-8 lg:px-12">
          <div className="w-full text-left">
            ...
            <h1 className="[font-family:var(--font-display)] text-[28px] xs:text-[34px] sm:text-[42px] md:text-[48px] lg:text-[52px] xl:text-[56px] font-normal leading-[1.12] sm:leading-[1.08] tracking-[-0.01em] text-black mb-3 xs:mb-4">
              {isAr ? "أقمشة فاخرة" : "Premium Fabrics"}
            </h1>
            ...
            <div className="flex items-center justify-between flex-wrap gap-4">
              <div className="flex items-center gap-4">
                <button
                  ...
                  aria-controls="fabric-store-mobile-filters"
        ...
        >
          ...
          <div
            id="fabric-store-mobile-filters"
            role="dialog"
            aria-modal="true"
