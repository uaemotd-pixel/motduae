    ...
    <nav className="fixed top-0 left-0 right-0 w-full z-50 border-b border-(--color-border) nav-blur">
      ...
      <div className="w-full min-h-14 xs:min-h-[60px] sm:min-h-16 md:min-h-18 flex items-center justify-between px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 2xl:px-16 3xl:px-24 4xl:px-32">
        ...
        <div className="flex items-center gap-1 xs:gap-1.5 sm:gap-2 md:gap-2 lg:gap-3 xl:gap-3 2xl:gap-4">
          {/* Language Switcher - exact structure from first code chunk */}
          <div className="language-switcher flex items-center gap-1 border-l border-r border-(--color-border) px-2 xs:px-2.5 sm:px-3 py-1">
            <button
              type="button"
              id="lang-en"
              className="lang-btn text-[9px] xs:text-[10px] lg:text-[11px] uppercase tracking-wider hover:opacity-70 transition px-1 font-medium active"
            >
              EN
            </button>
            <span className="text-(--color-grey-muted) text-[9px]">|</span>
            <button
              type="button"
              id="lang-ar"
              className="lang-btn text-[11px] xs:text-[12px] lg:text-[13px] hover:opacity-70 transition px-1 font-medium"
            >
              عربي
            </button>
          </div>
