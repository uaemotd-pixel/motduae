...
export default function DesignDetailView({
    ...
    const { name, description, category } = getDesignDisplayFields(design, locale);
    ...
    const tailorShopAddress = [
        design.tailorShop.location,
        design.tailorShop.city,
    ].filter((part) => part?.trim()).join(isAr ? "، " : ", ");
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                    ...
                    <div className="space-y-6">
                        <span
                            className="inline-block text-white text-[10px] uppercase tracking-[0.2em] px-2 py-1 bg-[#8B6F47]"
                        >
                            {category}
                        </span>
