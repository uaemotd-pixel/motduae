...
const TYPE_I18N_KEYS: Record<string, string> = {
  ...
  fabric_payout_completed: "fabricPayoutCompleted",
  ...
  tailor_payout_completed: "tailorPayoutCompleted",
...
export function getNotificationTypeLabel(type: string, t?: (key: string) => string): string {
  ...
  const labels: Record<string, string> = {
    ...
    fabric_payout_completed: "Payout sent",
    ...
    tailor_payout_completed: "Payout sent",
